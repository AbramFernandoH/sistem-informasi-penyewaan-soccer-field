          ...
          <div className='mx-auto w-full max-w-sm lg:w-96'>
            ...
            <div className='mt-10'>
              ...
              <div className='mt-10'>
                ...
                <a
                  href='#'
                  className='mt-10 flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent'
                >
                  <svg
                    viewBox='0 0 24 24'
                    aria-hidden='true'
