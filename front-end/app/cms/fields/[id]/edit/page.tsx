...
export default function EditField() {
  ...
  const onSubmit = (data: EditFieldRequest) => {
  ...
  // TODO: hit endpoint detail field for load detail field data to fill this forms
