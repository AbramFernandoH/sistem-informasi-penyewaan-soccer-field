...
export default function EditSchedule() {
  ...
  const onSubmit = (data: EditScheduleRequest) => {
    console.log(data)
  }

  return (
    <CMSLayout pages={breadcrumbsPages}>
      {/* TODO: change backUrl to detail schedule page when api is ready */}
      <Header
        title='Ubah Jadwal'
